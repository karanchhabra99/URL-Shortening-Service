...
function create() {
    ...
    .then(responseText => {
        ...
        document.getElementById('new_URL').innerHTML = "https://redirect-sug.s3.us-west-2.amazonaws.com/"+responseText["body"]+".html"// responseText;  // Fixed: Use responseText inside the function
    })
    .catch(error => {
